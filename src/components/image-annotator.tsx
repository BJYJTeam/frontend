...
export function ImageAnnotator({ onImageChange }: ImageAnnotatorProps) {
  ...
  const saveState = useCallback(() => {
    ...
    // Notify parent component of the new image data
    onImageChange(dataURL)
  }, [canvasRef, onImageChange])
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    // Create a copy of the previous state to draw on
    if (tool !== "pen") {
  ...
  // Draw different shapes based on selected tool
